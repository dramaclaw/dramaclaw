...
| [minimax-h3-liblib-request-contract](tasks/minimax-h3-liblib-request-contract.md) | LibLib MiniMax H3 真实请求/返回合同取证 | 已完成 | 四组真实样本、请求/返回、计费与未决限制已脱敏固化；未继续消耗积分，待随文档提交归档 |
